...
1) Создайте полный архив файловой системы рабочей ОС 
  ...
  1) Примонтируйте раздел "/" вашей системы в "/mnt/" Live-системы

  1) Примонтируйте остальные разделы вашей системы в нужные директории с префиксом "/mnt/"

  1) Создайте диреторию /backup и примонтируйте туда отдельный физический носитель достаточного объёма

  1) Склонируйте файловую систему с помощью команды
