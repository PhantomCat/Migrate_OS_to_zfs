...
1) Максимально облегчите систему, узнать, что занимает больше всего места поможет команда 
 ...
 ```
  ...
  1.1) Перенесите большие файлы, такие как видео, музыку и фотографии на отдельное хранилище на время миграции для сокращения времени работ. 
...
1) Создайте полный архив файловой системы рабочей ОС 
  ...
  1.1) Примонтируйте раздел "/" вашей системы в "/mnt/" Live-системы

  1.1) Примонтируйте остальные разделы вашей системы в нужные директории с префиксом "/mnt/"

  1.1) Создайте диреторию /backup и примонтируйте туда отдельный физический носитель достаточного объёма

  1.1) Склонируйте файловую систему с помощью команды
